...
(async () => {
  ...
  const tokenConfig = {
    ...
    decimals: 6,
    //
    name: "DuongHB - SBS 2024",
    //
    symbol: "DuongHB",
    //
    uri: "https://github.com/duonghb53/solana-bootcamp-summer-2024/main/week-1/assignment/assets/sbs-token.json",
    image:
      "https://github.com/duonghb53/solana-bootcamp-summer-2024/blob/main/week-1/assignment/assets/logo.png?raw=true",
  };
  ...
  */
  ...
  const amountOfTokensToMint = 100 * 10 ** 6; // 1 * 10**6
  const otherAddress = new PublicKey(
  ...
  const otherAssociatedToken = getAssociatedTokenAddressSync(
    mintKeypair.publicKey,
    otherAddress
  );
  ...
  const createOtherTokenAccountInstruction =
    createAssociatedTokenAccountInstruction(
      payer.publicKey,
      otherAssociatedToken,
      otherAddress,
      mintKeypair.publicKey
    );
  const mintInstruction1 = createMintToInstruction(
    mintKeypair.publicKey,
    payerAssociatedToken,
    payer.publicKey,
  ...
  const mintInstruction2 = createMintToInstruction(
    mintKeypair.publicKey,
    otherAssociatedToken,
    payer.publicKey,
    10 * 10 ** 6
  ...
  const tx = await buildTransaction({
    ...
    instructions: [
      ...
      createOtherTokenAccountInstruction,
      mintInstruction1,
      mintInstruction2,
    ],
  });
